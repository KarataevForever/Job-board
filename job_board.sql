...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 20 2022 г., 06:36
...
CREATE TABLE `qualifications` (
  `id` int NOT NULL,
  `qualifications` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `qualifications` (`id`, `qualifications`) VALUES
(1, 'intern'),
(2, 'junior');
...
ALTER TABLE `jobs`
  ...
  ADD CONSTRAINT `jobs_ibfk_8` FOREIGN KEY (`qualification`) REFERENCES `qualifications` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
